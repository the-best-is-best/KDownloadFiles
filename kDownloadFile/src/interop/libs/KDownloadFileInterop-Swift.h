...
#ifndef KDOWNLOADFILEINTEROP_SWIFT_H
#define KDOWNLOADFILEINTEROP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KDownloadFileInterop",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
+ (void)openFileWithFilePath:(NSString * _Nonnull)filePath;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
